...
public interface IDiscussionService extends IService<Discussion> {
    ...
    // 教师根据课程id或讨论标题获取自己发布的讨论(分页)
    Page<PageDiscussionVo> getOwnerDiscussions(String title, Integer subjectId, Integer currentPage, Integer size);
     ...
     * @return 分页查询结果
     */
    Page<PageDiscussionVo> pageDiscussionBysubject(String title, Integer currentPage, Integer size);
