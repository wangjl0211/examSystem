      ...
      try {
        ...
        if (this.$refs.charts) {
          ...
          const safeOption = {
            ...
            xAxis: {
              data: Array.isArray(this.option.xAxis?.data) ? this.option.xAxis.data : []
            },
            yAxis: this.option.yAxis || {},
            series: Array.isArray(this.option.series) ? this.option.series.map(s => ({
              ...s,
