<template>
  <div class="app-container">
    ...
    >
      ...
      <el-table-column label="考试时间" align="center" width="300px">
        ...
        <template #default="{ row }">
          <div style="display: flex; justify-content: space-around; align-items: center;">
            <el-button
              type="text"
              size="small"
              style="color:cornflowerblue; font-size: 14px; white-space: nowrap"
              @click="showExam(row)"
            >详情</el-button>
            <el-button
              type="text"
            ...
            <el-button
              type="text"
              size="small"
              style="color: red; font-size: 14px; white-space: nowrap"
              @click="delExam(row)"
            >删除</el-button>
          </div>
        </template>
    ...
    <!-- 显示详情对话框 -->
    <el-dialog title="显示详情" v-model="showExamDialogVisible">
      <el-row :gutter="20">
        <el-col :span="12">
      ...
      <el-row :gutter="20">
        <!-- <el-col :span="12">
          <el-form :model="form">
            <el-form-item label="考试课程" :label-width="formLabelWidth">
