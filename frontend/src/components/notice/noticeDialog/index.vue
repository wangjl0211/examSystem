  ...
  <el-dialog :title="title" v-model="visible" width="60%">
    <el-form :model="noticeForm" label-width="80px">
      <el-form-item label="公告标题">
        <el-input v-model="noticeForm.title" autocomplete="off" :disabled="!localIsEdit" />
      </el-form-item>
      <el-form-item label="是否公开">
        <el-switch
          v-model="noticeForm.isPublic"
          :disabled="!localIsEdit || roleEdit"
          active-color="#13ce66"
          inactive-color="#ff4949"
        />
      </el-form-item>
      <el-form-item v-if="!noticeForm.isPublic" label="公告课程">
        <ClassSelect
          v-model="noticeForm.subjectIds"
          :is-edit="!localIsEdit"
          is-multiple
        />
      </el-form-item>
